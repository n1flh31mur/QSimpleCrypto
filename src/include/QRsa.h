...
public:
    ...
    ///
    [[nodiscard]] EVP_PKEY* generateRsaKeys(quint32 bits, quint32 rsaBigNumber);
    ...
    ///
    void savePublicKey(EVP_PKEY* key, const QByteArray& fileName);
    ...
    ///
    void savePrivateKey(EVP_PKEY* key, const QByteArray& fileName, QByteArray password = "", const EVP_CIPHER* cipher = nullptr);
