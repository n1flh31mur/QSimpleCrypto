...
///
/// \brief QSimpleCrypto::QBlockCipher::generateSalt - Function generates random bytes by size.
/// \param size - Size of generated bytes.
/// \return Returns random bytes.
///
QByteArray QSimpleCrypto::QBlockCipher::generateSalt(const qint32 &size)
{
...
///
QByteArray QSimpleCrypto::QBlockCipher::encryptAesBlockCipher(QByteArray data, QByteArray key, QByteArray iv, QByteArray password, QByteArray salt, const int& rounds, const EVP_CIPHER* cipher, const EVP_MD* md)
{
    try {
...
/// \return Returns decrypted data or "", if error happened.
///
QByteArray QSimpleCrypto::QBlockCipher::decryptAesBlockCipher(QByteArray data, QByteArray key, QByteArray iv,
    QByteArray password, QByteArray salt, const int& rounds,
