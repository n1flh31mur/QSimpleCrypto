...
/// \return
///
QByteArray AuthenticatedEncryption::encrypt_aes_gcm(const EVP_CIPHER* cipher, QByteArray data,
    unsigned char key[],
...
/// \return
///
QByteArray AuthenticatedEncryption::decrypt_aes_gcm(const EVP_CIPHER* cipher, QByteArray data,
    unsigned char key[],
    unsigned char iv[], const int& iv_length,
    unsigned char aad[], const int& aad_length,
    unsigned char tag[], const int& tag_length)
...
/// \return
///
QByteArray AuthenticatedEncryption::encrypt_aes_ccm(const EVP_CIPHER* cipher, QByteArray data,
    unsigned char key[],
    unsigned char iv[], const int& iv_length,
    unsigned char aad[], const int& aad_length,
    unsigned char tag[], const int& tag_length)
...
/// \return
///
QByteArray AuthenticatedEncryption::decrypt_aes_ccm(const EVP_CIPHER* cipher, QByteArray data,
    unsigned char key[],
    unsigned char iv[], const int& iv_length,
    unsigned char aad[], const int& aad_length,
    unsigned char tag[], const int& tag_length)
